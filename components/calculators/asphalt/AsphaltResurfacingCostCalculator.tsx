...
export default function AsphaltResurfacingCostCalculator() {
    const [area, setArea] = useState<number>(1000);
    const [costPerSqFt, setCostPerSqFt] = useState<number>(5);
    ...
    const handleCalculate = () => {
        if (area <= 0 || costPerSqFt <= 0) return;
    ...
    const isValid = area > 0 && costPerSqFt > 0;

    return (
        <section aria-label="Asphalt Resurfacing Cost Calculator">
            <div className={containerClasses}>
                <div className="mb-6">
                    <h2 className="text-[18px] font-semibold tracking-[-0.01em] text-slate-900">Resurfacing Inputs</h2>
                </div>
                ...
                <div className="grid gap-6">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <p className="text-[12px] text-slate-500">Resurfacing (overlay) is typically $3 – $7 / sq ft.</p>
                    </div>
                    ...
                    >
                        <div ref={resultsInnerRef} className="pt-2">
                            <div className="rounded-2xl border border-teal-100 bg-white p-6 shadow-sm">
                                <div className="mb-4">
                                    <h3 className="text-[16px] font-semibold text-slate-900">Resurfacing Estimate</h3>
                                </div>
                                ...
                                <div className="grid gap-3 sm:grid-cols-2">
                                    ...
                                    <div className="rounded-xl bg-slate-50 p-3 border border-slate-200">
                                        <dt className="text-[12px] text-slate-500 uppercase tracking-wider font-semibold">Resurface Rate</dt>
                                        <dd className="text-[18px] font-semibold text-slate-900 mt-1">
                                ...
                                <p className="mt-4 text-[13px] text-slate-500 leading-relaxed">
                                    Resurfacing estimates cover a new asphalt layer over an existing surface. This excludes edge milling or extensive base repairs.
                                </p>
                            </div>
                        </div>
                    </div>
