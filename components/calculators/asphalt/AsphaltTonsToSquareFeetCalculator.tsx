...
export default function AsphaltTonsToSquareFeetCalculator() {
    ...
    const isValid = isFiniteNumber(tons) && tons > 0 && isFiniteNumber(thickness) && thickness > 0;

    return (
        <section aria-label="Asphalt Tons to Square Feet Calculator">
                    ...
                    >
                        <div ref={resultsInnerRef} className="pt-2">
                            <div className="rounded-2xl border border-indigo-100 bg-white p-6 shadow-sm">
                                <span className="text-[13px] font-medium text-indigo-900/60 uppercase tracking-wider block mb-1">Coverage Result</span>
                                <div className="flex items-baseline gap-2 mb-6">
                                    <span className="text-[42px] font-bold text-slate-900 tracking-tight">
                                        {formatNumber(result.areaSqFt, 0)}
                                    </span>
                                ...
                                <dl className="grid gap-3 sm:grid-cols-2">
                                    <div className="rounded-xl bg-slate-50 p-3 border border-slate-200">
                                        ...
                                        <dd className="text-[16px] font-semibold text-slate-900">
                                            {formatNumber(result.areaSqYd, 1)} yd²
                                        </dd>
                                    </div>
                                    <div className="rounded-xl bg-slate-50 p-3 border border-slate-200">
