...
export default function AsphaltRepairCostCalculator() {
    const [length, setLength] = useState<number>(10);
    const [width, setWidth] = useState<number>(10);
    const [costPerSqFt, setCostPerSqFt] = useState<number>(12);
    ...
    return (
        <section aria-label="Asphalt Repair Cost Calculator">
            <div className={containerClasses}>
                <div className="mb-6">
                    <h2 className="text-[18px] font-semibold tracking-[-0.01em] text-slate-900">Repair Area Details</h2>
                </div>
                ...
                <div className="grid gap-6">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <p className="text-[12px] text-slate-500">Patching/Repair jobs usually cost slightly more per sq ft than full paving.</p>
                    </div>
                    ...
                    >
                        <div ref={resultsInnerRef} className="pt-2">
                            <div className="rounded-2xl border border-red-100 bg-white p-6 shadow-sm">
                                <div className="mb-4">
                                    <h3 className="text-[16px] font-semibold text-slate-900">Asphalt Repair Estimate</h3>
                                </div>
                                ...
                                <div className="grid gap-3 sm:grid-cols-2">
                                    <div className="rounded-xl bg-slate-50 p-3 border border-slate-200">
                                        <dt className="text-[12px] text-slate-500 uppercase tracking-wider font-semibold">Repair Area</dt>
                                        <dd className="text-[18px] font-semibold text-slate-900 mt-1">
                                            {formatNumber(result.area, 0)} sq ft
                                        </dd>
                                    </div>
                                    <div className="rounded-xl bg-slate-50 p-3 border border-slate-200">
                                        <dt className="text-[12px] text-slate-500 uppercase tracking-wider font-semibold">Unit Cost</dt>
                                        <dd className="text-[18px] font-semibold text-slate-900 mt-1">
                                ...
                                <p className="mt-4 text-[13px] text-slate-500 leading-relaxed">
                                    This estimate covers material and labor for localized patching or repair. Note that many contractors have a 'minimum job fee' regardless of the area size.
                                </p>
                            </div>
                        </div>
                    </div>
